...
class DeleteUserConsoleCommand extends ConsoleCommand
{
    /** @var CommandBus */
    private $commandBus;
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Delete user given id')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $io->title('Tic tac toe - Delete User');
            ...
            $output->write('<fg=green>User delete successfully</fg=green>');
