...
class GetGameHandlerTest extends TestCase
{
    ...
    {
        $getGameHandler = new GetGameHandler($this->getGame);
        $response = $getGameHandler->__invoke(new GetGameQuery(self::FAKE_GAME_UUID));
